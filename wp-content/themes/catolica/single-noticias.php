...
<?php $news = new WP_Query( array( 'post_type' => 'noticias', 'posts_per_page' => 3, 'post__not_in' => array( $post_id ) ) ); ?>


<?php while ( $news->have_posts() ) : $news->the_post(); ?>

<?php $image = wp_get_attachment_url( get_post_thumbnail_id($news->ID), 'thumbnail' ); ?>
